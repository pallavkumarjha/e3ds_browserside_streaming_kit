function updateAppConfig() 
	  ...
	  return obj
		...
		function afterGettingAppConfig() 
		{
          ...
          <!-- appconfigPassed2Ejs =<%-JSON.stringify(appconfig)%> -->
		...
		//config path
			...
			let fullDomain="connector.eagle3dstreaming.com"
			  //fullDomain="connector_staging.eaglepixelstreaming.com"
			  //fullDomain="connector_ms6.eaglepixelstreaming.com"
			let compnay="demo"
			...
			//window.location.search: ?GuestMeetingId=5cfa95d9-c540-455c-9086-1715c600daa1
			let search=""
...
//urlParams: 
//GuestMeetingId 5cfa95d9-c540-455c-9086-1715c600daa1			
			...
			//https://connector.eagle3dstreaming.com/v5/demo/CarConfigurator427/AlekseenkoConfig?hostMeetingId=dca7d0bb-aa94-418a-8fff-2eacc34ad4d8
			//https://connector.eagle3dstreaming.com/v5/demo/CarConfigurator427/usmanDebugging?GuestMeetingId=21d666ba-a0d8-4db9-9643-e74525bafe1b
